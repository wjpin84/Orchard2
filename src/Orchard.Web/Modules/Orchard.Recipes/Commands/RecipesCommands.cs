...
namespace Orchard.Recipes.Commands
{
    public class RecipesCommands : DefaultOrchardCommandHandler
    {
        ...
        public async void Harvest(string extensionId)
        {
        ...
        public async void Execute(string extensionId, string recipeName)
        {
            var extensionDescriptor = _extensionManager.GetExtension(extensionId);
            if (extensionDescriptor == null)
            {
        ...
        public async void Result(string executionId)
        {
            var result = await _recipeResultAccessor.GetResultAsync(executionId);
